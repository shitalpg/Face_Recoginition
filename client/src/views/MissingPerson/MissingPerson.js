...
const CriminalForm = () => {
 ...
 Female  <input
  ...
  />
        ...
        <button type="button" onClick={missingPersonData} className="bg-slate-950 hover:bg-blue-800 text-white font-bold mt-5 py-2 px-5 block mx-auto rounded-lg" >Submit</button>
      </form>
    </div>
' 

<button type='button'className="bg-slate-950 hover:bg-blue-800 text-white  py-2 px-5 my-4 rounded-lg text-xl block mx-auto"  ><Link to="/missingPersonData" className='text-white no-underline'>  Get Missing Person's Data →</Link></button>
